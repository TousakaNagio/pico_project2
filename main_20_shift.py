...
def init():
    ...
    global normal_speed, climbing_speed, low_speed, falling_speed, shift_speed
    normal_speed = 5.78
    climbing_speed = 6.54
    shift_speed = 6.57
    low_speed = 5.70
    falling_speed = climbing_speed - 0.01
...
#     utime.sleep(1)
    ...
    # 5th stage
    print('stage 5')
    fan.update(shift_speed)
    ack_front.shift_left(33)
    ack_back.shift_left(33)
    brake.zero()
    ...
    print('stage 7')
    count_b = 0
    fan.update(climbing_speed + 0.13)
    photo.zero()
    while True:
        d = photo.count_distance()
        utime.sleep(0.01)
